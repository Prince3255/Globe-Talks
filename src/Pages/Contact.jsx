...
export default function Contact() {
    ...
    const onSubmit = async (event) => {
        ...
        if (data.success) {
          ...
          event.target.reset();
            ...
            Swal.fire({
                title: 'Error!',
                text: 'Please just refresh the page',
                icon: 'error',
    ...
    return (
      <div className="relative flex items-top justify-center min-h-[100vh] bg-white sm:items-center p-10 pb-20 sm:pt-0 mt-36 md:mt-8">
                ...
                <div className="mt-8 overflow-hidden">
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <form className="p-6 flex flex-col justify-center" onSubmit={onSubmit}>
                            ...
                            <input type="hidden" name="access_key" value="37d92c8a-61a3-4b43-bc39-4176b6c3d3d8"></input>
                        </form>
                    </div>
                </div>
            </div>
